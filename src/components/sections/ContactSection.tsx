...
export default function ContactSection() {
  return (
    <section className="py-24 bg-muted relative overflow-hidden" id="contact-preview">
      ...
      {/* Seamless Repeating Organic Pine Needle & Leaf Branch Pattern - Parallax depth */}
      <ParallaxLayer speed={0.2} className="absolute top-[60px] md:top-[90px] bottom-0 left-0 right-0 pointer-events-none z-0 overflow-hidden">
        <div
          style={{
      ...
      {/* Arrow Up Divider (kept for contact section) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="space-y-12 lg:pt-10">
            <div className="space-y-6">
              <TextRevealByWord
                text="GET IN TOUCH."
                className="font-sans text-5xl md:text-6xl font-black text-primary tracking-tighter uppercase text-center lg:text-left"
