    ...
    <Card className={cn("border-none shadow-xl bg-background p-0 overflow-hidden rounded-3xl", className)}>
      <CardContent className="p-0">
        <div className="bg-primary p-8 text-primary-foreground">
          ...
          <h3 className="font-serif text-3xl font-bold">How can we help?</h3>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="emergency">Storm Cleanup</option>
          ...
          {status === "error" && (
            <div className="flex items-center gap-2 p-4 bg-red-50 text-red-700 rounded-xl">
              ...
              <p className="text-sm font-medium text-balance">Something went wrong. Please try again or call us directly.</p>
            </div>
          )}
