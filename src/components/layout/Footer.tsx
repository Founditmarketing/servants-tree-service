                ...
                <div className="container mx-auto px-4 md:px-6 text-white">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
                        <div className="space-y-8">
                            <Link to="/" className="flex my-10 items-center gap-4 group">
                                <div className="bg-primary p-1 rounded-[50%] shadow-lg shadow-primary/40 transition-transform hover:scale-110">
                                    <img src="/images/Logo.png" alt="Logo" className="max-h-24 min-h-12 w-auto min-w-12  object-contain" />
                                </div>

                                <span className="font-sans text-2xl font-black text-white tracking-widest">
                                    SERVANT'S TREE SERVICE
                                </span>
                            </Link>
                            {/*
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 text-sm font-medium text-white/60 uppercase tracking-tighter">
                                <li className="hover:text-white transition-colors cursor-default"><Link to="/services/tree-removal" className="text-white/60 hover:text-white transition-colors">Tree Removal</Link></li>
                                <li className="hover:text-white transition-colors cursor-default"><Link to="/services/tree-trimming" className="text-white/60 hover:text-white transition-colors">Tree Trimming</Link></li>
                                <li className="hover:text-white transition-colors cursor-default"><Link to="/services/debris-hauling" className="text-white/60 hover:text-white transition-colors">Debris Hauling</Link></li>
                                <li className="hover:text-white transition-colors cursor-default"><Link to="/services/land-clearing" className="text-white/60 hover:text-white transition-colors">Land Clearing</Link></li>
                                <li className="hover:text-white transition-colors cursor-default"><Link to="/services/tree-inspections" className="text-white/60 hover:text-white transition-colors">Tree Inspections</Link></li>
                                <li className="hover:text-white transition-colors cursor-default"><Link to="/services/pruning" className="text-white/60 hover:text-white transition-colors">Pruning</Link></li>
                            </ul>
                        </div>
