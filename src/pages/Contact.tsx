  ...
  return (
    <main className="min-h-screen bg-muted/20 pb-24">
      ...
      <section className="py-32 bg-primary relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full bg-black/20 -skew-x-12 transform translate-x-1/4 z-0 shadow-2xl hidden lg:block" />
        <div className="absolute top-0 right-0 w-full lg:w-1/2 h-40 lg:h-full bg-black/20 z-0 lg:hidden" />
          ...
          <div className="max-w-4xl mx-auto flex flex-col gap-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center md:text-left space-y-6">
                <h2 className="font-sans text-3xl md:text-4xl font-black text-primary tracking-tight">Expert Tree Removal Services</h2>
              ...
              {/* Intro Image */}
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-64 md:h-full min-h-[300px]">
                <img 
                  src="/images/IMG_2497-scaled.jpg" 
                  alt="Expert Tree Removal"
