    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-24 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="font-sans text-4xl font-black text-foreground mb-8 tracking-tight">READY FOR YOUR TRANSFORMATION?</h2>
          <button className="bg-accent text-white px-10 py-6 rounded-xl font-black uppercase tracking-widest shadow-xl shadow-accent/20 hover:scale-[1.02] transition-all">
            Get A Free Estimate
          </button>
        </div>
      </section>
