            ...
            <section className="py-32 bg-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    ...
                    >
                        ...
                        <h1 className="font-sans text-5xl sm:text-7xl lg:text-8xl font-black mt-6 mb-8 tracking-tighter text-white uppercase">LAND <br /><span className="text-accent italic">CLEARING</span></h1>
