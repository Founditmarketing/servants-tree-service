    ...
    <main className="min-h-screen bg-background text-foreground">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            <div className="inline-flex items-center space-x-2 text-primary font-bold text-xs uppercase tracking-[0.4em] mb-4">
              ...
              <span>Scientific Diagnosis & Analysis</span>
            </div>
            ...
            <p className="text-muted-foreground text-lg max-w-xl leading-relaxed font-medium">
              Identifying liabilities before they become disasters. Professional risk assessments and health diagnostics by certified arborist consultants.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed font-medium">
                A tree can look healthy from the outside while harborina structural rot or internal pests. Our inspections provide a deep-dive into the biological and mechanical health of your trees, giving you peace of mind and data-backed maintenance recommendations.
              </p>
            ...
            <div className="bg-primary/5 p-12 rounded-2xl border border-primary/10 shadow-2xl relative overflow-hidden">
              <Search className="w-16 h-16 text-accent mb-6" />
              <h3 className="text-2xl font-black text-primary mb-4 uppercase">Documented Certification</h3>
              <p className="text-muted-foreground font-medium leading-relaxed mb-8">
                We provide written health reports for insurance companies, property management firms, and prospective home buyers, ensuring the historical health record of your trees is maintained.
              </p>
              <Link to="/contact">
                <Button className="w-full bg-primary text-white font-black py-6 rounded-xl hover:bg-primary/90">
                  Book Expert Inspection
                </Button>
              </Link>
            </div>
          </div>
      ...
      <section className="py-24 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="text-3xl font-black text-primary uppercase tracking-tight mb-16">The Value of Analysis</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Prevention", desc: "Identify pest infestations like Emerald Ash Borer before they cause total tree loss." },
              { title: "Liability", desc: "Protect your property from liability cases by addressing known hazards early." },
              { title: "Integrity", desc: "Use scientific data to guide pruning and structural support decisions." }
            ].map((v) => (
              <div key={v.title} className="p-10 bg-white rounded-2xl shadow-sm border border-border/50">
                <ShieldCheck className="w-8 h-8 text-accent mx-auto mb-4" />
                <h4 className="text-xl font-black mb-4 uppercase tracking-tighter text-foreground">{v.title}</h4>
      ...
      <section className="py-24 text-center">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-4xl md:text-6xl font-black text-foreground mb-8 tracking-tighter">DON'T GUESS. DIAGNOSE.</h2>
          <Link to="/contact">
